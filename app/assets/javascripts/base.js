$(document).ready(function() {
  ...
  var items_replace = new Array('.colors h3, .home > a, nav.invite a, .send-button, #share-mail h1, #import-contacts h1, .box h3, #invite-mail h1, .full-banner .close, .full-banner li')
