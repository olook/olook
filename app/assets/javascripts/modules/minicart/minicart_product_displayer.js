var MinicartProductDisplayer  = (function(){
  ...
  var displayProduct = function(product){
    $('.js-minicart').append('<li class="product_item" data-id="975425"><img alt="'+product.name+'" src="'+product.thumb_picture+'" title="'+product.name+'"><h2>"'+product.formatted_product_name+'"</h2><p class="size">Tamanho: '+product.size+'</p><p class="qte">Quantidade:<span>'+product.quantity+'</span></p><p class="price">R$ '+parseToCurrency(product.retail_price)+'</p></li>');
  }
