...
initBase = {
  ...
  youtubePlayer : function(yt_id) {
    return "<div style='width:791px;height:445px;position:relative;z-index:1'><iframe style='position:absolute;top:0;left:0;z-index:1' width='791' height='445' src='http://www.youtube.com/embed/"+ yt_id +"?rel=0&autoplay=1&vq=large' frameborder='0'></iframe></div>";
  },
