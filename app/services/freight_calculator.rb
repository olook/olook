...
module FreightCalculator
  ...
  def self.freight_for_zip(zip_code, order_value, shipping_service_ids = nil, use_message = false)
    ...
    return {default_shipping: {price: DEFAULT_FREIGHT_PRICE, cost: DEFAULT_FREIGHT_COST,delivery_time: DEFAULT_INVENTORY_TIME,shipping_service_id: DEFAULT_FREIGHT_SERVICE}} if freight_prices.blank?
