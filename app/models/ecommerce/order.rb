...
class Order < ActiveRecord::Base
  ...
  scope :with_complete_payment, with_payment.where("payments.state IN ('authorized','completed')")

  scope :purchased , where("orders.state NOT IN ('canceled', 'reversed', 'refunded', 'in_the_cart')")
