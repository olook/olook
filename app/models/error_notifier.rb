class ErrorNotifier
  ...
  def self.send_notifier(gateway_name, error, payment)
    ...
    ActionMailer::Base.mail(:from => "admin@olook.com.br", :to => "nelson.haraguchi@olook.com.br,tiago.almeida@olook.com.br,rafael.manoel@olook.com.br", :subject => "ErrorNotifier: #{error_message}", :body => _body).deliver
