class ProductProductDocumentAdapter
  ...
  private
    ...
    def populate_ranking_fields(product, product_doc)
      product_doc.r_age = ranking_calculator.calculate_ranking_age(product_doc) rescue 0
      product_doc.r_brand_regulator = ranking_calculator.brand_regulator(product_doc.brand) rescue 0
      proportion = ranking_calculator.calculate_proportion_for_ranking_fields(product) rescue 1
