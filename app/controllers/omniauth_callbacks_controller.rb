...
class OmniauthCallbacksController < Devise::OmniauthCallbacksController
  ...
  private
    ...
    def facebook_redirect_paths
      {:friends => friends_home_path, :gift => gift_root_path, :showroom => root_path, :checkout => new_checkout_url(protocol: ( Rails.env.development? ? 'http' : 'https' )), :quiz => profile_path}
    end
