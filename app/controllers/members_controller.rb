...
class MembersController < ApplicationController
  ...
  def import_contacts
    begin
      ...
      redirect_to(root_path, :notice => "Seus contatos não puderam ser importados agora. Por favor tente novamente mais tarde.")
    end
  end
  ...
  def invite_imported_contacts
    ...
    redirect_to(root_path, :notice => "#{invites.length} Convites enviados com sucesso!")
  end
  ...
  def earn_credits
    after_login_return_to root_path
  end
