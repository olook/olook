...
class ApplicationController < ActionController::Base
  ...
  protected
    ...
    def seo_info
      @seo_info ||= Seo::SeoManager.new(request.path, fallback_title: @product.try(:title_text),fallback_description: @product.try(:description), color: @color, size: @size).select_meta_tag
    end
