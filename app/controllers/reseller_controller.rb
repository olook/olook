...
class ResellerController < ApplicationController
  ...
  def create
    ...
    if @reseller.save
      ...
      SACAlertMailer.reseller_notification(@reseller, "luciana.cremonezi@olook.com.br,financeiro@olook.com.br,diogo.silva@olook.com.br,rafael.manoel@olook.com.br,tiago.almeida@olook.com.br").deliver
