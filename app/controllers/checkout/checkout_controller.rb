...
class Checkout::CheckoutController < Checkout::BaseController
  ...
  def create_debit
    ...
    if @payment.valid?
      ...
      payment_builder = PaymentBuilder.new({ :cart_service => @cart_service, :payment => @payment, :gateway_strategy => moip_sender_strategy, :tracking_params => session[:tracking_params] } )
  ...
  def create_credit_card
    ...
    if @payment.valid?
      ...
      payment_builder = PaymentBuilder.new({ :cart_service => @cart_service, :payment => @payment, :gateway_strategy => sender_strategy, :tracking_params => session[:tracking_params] } )
      response = payment_builder.process!
