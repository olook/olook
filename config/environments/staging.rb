...
Olook::Application.configure do
  ...
  config.assets.precompile += %w(*.js admin.css admin/*.css admin/*.js about/*.css common/*.js gift/*.js plugins/*.js ui/*.js section/*.css utilities/*.css fonts/*.svg fonts/*.eot fonts/*.woff fonts/*.ttf *.ttf)
