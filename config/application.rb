...
module Olook
  class Application < Rails::Application
    ...
    config.assets.precompile += %w(*.js admin.js admin.css campaign_emails.css admin/*.css admin/*.js about/*.css common/*.js gift/*.js plugins/*.js ui/*.js section/*.css utilities/*.css new_structure/lite_application.css new_structure/section/*.css new_structure/partials/* new_structure/common/*)
