...
module Olook
  class Application < Rails::Application
    ...
    config.assets.precompile += %w(*.js admin.js desktop.css admin.css campaign_emails.css reseller.css admin/*.css admin/*.js about/*.css common/* gift/*.js plugins/*.js ui/*.js section/*.css utilities/*.css new_structure/lite_application.css new_structure/section/*.css new_structure/partials/*)
