...
survey_data[0] = {
  :question_title => "1 de 25. Com qual dessas celebridades brasileiras você se identifica mais?",
...
survey_data[1] = {
  :question_title => "2 de 25. Com qual dessas celebridades internacionais você se identifica mais?",
...
survey_data[2] = {
  :question_title => "3 de 25. De qual desses ícones de estilo você gostaria de herdar o guarda-roupa?",
...
survey_data[3] = {
  :question_title => "4 de 25. Qual dessas peças não pode faltar no seu dia a dia?",
...
survey_data[4] = {
  :question_title => "5 de 25. Qual desses estilos de cabelo mais te agradam?",
...
survey_data[5] = {
  :question_title => "6 de 25. Se pudesse voltar no tempo, que época da moda você escolheria?",
...
survey_data[7] = {
  :question_title => "8 de 25. Se você fosse escolher um estilo de dança para aprender, qual seria?",
...
survey_data[8] = {
  :question_title => "9 de 25. Qual dessas revistas femininas você tem o hábito de ler?",
...
survey_data[11] = {
  :question_title => "12 de 25. Escolha o look que mais te agrada para o dia a dia.",
...
survey_data[12] = {
  :question_title => "13 de 25. Escolha o look que mais te agrada para noite.",
...
survey_data[13] = {
  :question_title => "14 de 25. Quais acessórios você usaria para trabalhar?",
...
survey_data[14] = {
  :question_title => "15 de 25. Quais acessórios você usaria para um domigo à tarde?",
...
survey_data[15] = {
  :question_title => "16 de 25. Quais acessórios você usaria em uma festa?",
...
survey_data[16] = {
  :question_title => "17 de 25. Quais acessórios você escolheria para um pretinho básico?",
...
survey_data[17] = {
  :question_title => "18 de 25. Maquiagem para você é...",
...
survey_data[18] = {
  :question_title => "19 de 25. Como você costuma combinar as cores?",
...
survey_data[19] = {
  :question_title => "20 de 25. Como você gosta do caimento das suas roupas?",
...
survey_data[20] = {
  :question_title => "21 de 25. Que tipo de acessório mais te agrada?",
...
survey_data[21] = {
  :question_title => "22 de 25. Que tipo de salto você prefere?",
  :answers => ["Alto", "Médio", "Baixo", "Rasteirinha"],
  :weights => []
}

survey_data[22] = {
  :question_title => "23 de 25. Quais palavras você mais gosta? (Escolha 3 opções)",
