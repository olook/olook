...
describe MarketingReports::Builder do
  ...
  describe "#userbase" do
    ...
    before(:each) do
      ...
      MarketingReports::SendgridClient.stub(:new).with(:bounces, :type => "soft", :username => "olook").and_return(bounce_response)
      MarketingReports::SendgridClient.stub(:new).with(:bounces, :type => "soft", :username => "olook2").and_return(bounce_response)
    end
