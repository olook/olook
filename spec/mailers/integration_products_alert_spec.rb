...
describe IntegrationProductsAlert do
  describe '.notify' do
    ...
    it "creates email" do
      mail.stub(:deliver)
      described_class.any_instance.should_receive(:mail).with({ to: "#{ email }, rafael.manoel@olook.com.br, nelson.haraguchi@olook.com.br", subject: "Sincronização de produtos concluída"}).and_return(mail)
