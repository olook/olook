...
describe SurveyQuestions do
  ...
  it "should return title color question" do
    subject.title_color_question.should == "23. Dê uma nota para cada uma das cartelas de cores abaixo."
  end

  it "should return title about question" do
    subject.title_about_question.should == "24. Conte-nos um pouco sobre você:"
  end
end
