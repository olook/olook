...
describe AssociateProductWithCollectionThemeService do
  ...
  describe "#process!" do
    ...
    it 'should associate product with collection theme' do
      service = AssociateProductWithCollectionThemeService.new(@content)
      service.process!
