describe Freight::TransportShippingChooserService do
  ...
  context "When have one shipping" do
    it "return formated hash" do
      ship = {default_shipping: { price: '15.99'.to_d, cost: '9.99'.to_d, :delivery_time=>@shipping.delivery_time + FreightCalculator::DEFAULT_INVENTORY_TIME, :shipping_service_id=>1}}
    ...
    context "and dont receive any attributes" do
      it "return default value from freight calculator" do
        ...
        ship = {default_shipping: { price: '15.99'.to_d, cost: FreightCalculator::DEFAULT_FREIGHT_COST.to_d, :delivery_time=> @shipping.delivery_time + FreightCalculator::DEFAULT_INVENTORY_TIME, :shipping_service_id=>1}}
  ...
  context "When there is more than one shippings" do
    ...
    it "return better shipping" do
      ship = {default_shipping: { price: '15.99'.to_d, cost: '4.99'.to_d, :delivery_time=> @better_cost_shipping.delivery_time + FreightCalculator::DEFAULT_INVENTORY_TIME, :shipping_service_id=>2}}
    ...
    context "and there is fast shipping" do
      ...
      it "return default and fast shippings" do
        ship = {default_shipping: { price: '15.99'.to_d, cost: '4.99'.to_d, :delivery_time=> @better_cost_shipping.delivery_time + FreightCalculator::DEFAULT_INVENTORY_TIME, :shipping_service_id=>2},
                fast_shipping: {price: '15.99'.to_d, cost: '14.99'.to_d, :delivery_time=> @fast_shipping.delivery_time + FreightCalculator::DEFAULT_INVENTORY_TIME, :shipping_service_id=>3}}
