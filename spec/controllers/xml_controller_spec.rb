...
describe XmlController do
  ...
  describe "GET criteo" do
    ...
    it "gets only products for xml" do
      Product.should_receive(:products_blacklist).and_return([1,2,3])
      Product.should_receive(:collections_blacklist).and_return([4,5,6])
  ...
  def stub_scope_params
    Product.should_receive(:products_blacklist).and_return([0])
    Product.should_receive(:collections_blacklist).and_return([0])
  end
