...
describe Abacos::UpdateOrderStatus do
  describe "#perform" do
    ...
    it "should download and parse order statuses" do
      ...
      Resque.should_receive(:enqueue).with(Abacos::IntegrateOrderStatus, Abacos::OrderStatus.to_s, :status_a)
      Resque.should_receive(:enqueue).with(Abacos::IntegrateOrderStatus, Abacos::OrderStatus.to_s, :status_b)
