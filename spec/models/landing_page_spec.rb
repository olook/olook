...
describe LandingPage do
  ...
  context "attributes validation" do
    ...
    context "#button_top" do
      it {should ensure_inclusion_of(:button_top).in_range(0..1000) }
    end

    context "#button_left" do
      it {should ensure_inclusion_of(:button_left).in_range(0..1000) }
    end
  end
