...
describe SynchronizationEvent do
  context "validations" do
    ...
    it 'should raise an exception if a not allowed name is given' do
      expect { FactoryGirl.create(:weird_name_synchronization_event) }.to raise_exception
    end
    ...
    it 'should raise an exception if an event was created less than 10 minutes before' do
      ...
      expect { FactoryGirl.create(:locked_synchronization_event) }.to raise_error(ActiveRecord::RecordInvalid)
    end
  end
end
