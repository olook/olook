...
FactoryGirl.define do
  ...
  factory :authorized_payment, :parent => :payment_response do
  ...
  factory :canceled_payment, :parent => :payment_response do
    response_status "Sucesso"
  ...
  factory :authorized_response, :class => PaymentResponse do
    response_status "Sucesso"
    transaction_status "EmAnalise"
    message "Transação autorizada"
    transaction_code "046455"
