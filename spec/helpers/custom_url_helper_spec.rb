  ...
  describe "#retrieve_filter" do
    context "When request full path equals to /sapato" do
      ...
      it "returns catalog catalog filter and category" do
        expect(retrieve_filter(controller.request.fullpath)).to eql ["catalog/filters", "sapato"]
      end
    end
    context "When request full path equals to /colecoes" do
      ...
      it "returns catalog collection_themes filter" do
        expect(retrieve_filter(controller.request.fullpath)).to eql "collection_themes/menu"
      end
    end
    context "When request full path equals to /marcas" do
      ...
      it "returns catalog brands filter" do
        expect(retrieve_filter(controller.request.fullpath)).to eql "brands/side_filters"
      end
    end
  end
end
